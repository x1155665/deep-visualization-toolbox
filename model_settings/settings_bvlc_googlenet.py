...
caffevis_deploy_prototxt = base_folder + './models/bvlc-googlenet/bvlc-googlenet-deploy.prototxt'
caffevis_network_weights = base_folder + './models/bvlc-googlenet/bvlc_googlenet.caffemodel'
